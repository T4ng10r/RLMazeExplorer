...
//	Q_ASSERT(bResult==true);
    ...
    Q_ASSERT(bResult==true);
	bResult=connect(m_ptrDataThread,SIGNAL(mazeHasBeenGenerated(CMaze *)),SLOT(onMazeHasBeenGenerated(CMaze *)));
	Q_ASSERT(bResult==true);
...
void	MainWindow::onMazeHasBeenGenerated(CMaze * ptrMaze)
