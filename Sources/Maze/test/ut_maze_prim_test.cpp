...
class ut_maze_prim_test : public ::testing::Test
{
public:
...
TEST_F(ut_maze_prim_test, test_maze_locations_integrity)
{
...
TEST_F(ut_maze_prim_test, test_maze_locations_connections)
{
