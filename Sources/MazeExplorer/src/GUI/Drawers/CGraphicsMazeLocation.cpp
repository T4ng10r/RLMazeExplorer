...
void CGraphicsMazeLocation::setLocationData(const location & locData)
{
    ...
    //////////////////////////////////////////////////////////////////////////
	m_vLines.clear();
    if (m_LocData.is_wall(NORTH_DIR))
    {
        QLineF line;
	...
	if (m_LocData.is_wall(SOUTH_DIR))
    {
        QLineF line;
