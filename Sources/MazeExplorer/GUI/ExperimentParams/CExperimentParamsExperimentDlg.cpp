...
{
    groupLearningParam->setTitle(QApplication::translate("param_eks", "Parametry uczenia", 0, QApplication::UnicodeUTF8));
    labelLearningMethod->setText(QApplication::translate("param_eks", "Metoda", 0, QApplication::UnicodeUTF8));
    pushLearningMethod->setText(QApplication::translate("param_eks", "?", 0, QApplication::UnicodeUTF8));
    labelPenaltyValue->setText(QApplication::translate("param_eks", "Warto\305\233\304\207 kary", 0, QApplication::UnicodeUTF8));
    labelPriceValue->setText(QApplication::translate("param_eks", "Warto\305\233\304\207 nagrody", 0, QApplication::UnicodeUTF8));
    pushPriceValue->setText(QApplication::translate("param_eks", "?", 0, QApplication::UnicodeUTF8));
    pushPenaltyValue->setText(QApplication::translate("param_eks", "?", 0, QApplication::UnicodeUTF8));
}
