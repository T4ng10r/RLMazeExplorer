...
Q_SIGNALS:
	...
	void experimentSettingsChanged(const experiment_settings &);
	//xMazeSettings
	void startExperiment(experiment_settings & cExperimentSettings);
	void setStartDirection(int);
public Q_SLOTS:
	void onSetExperimentSettings(experiment_settings & cExperimentSettings);
